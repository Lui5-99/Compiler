...
LT, EQ, GT, ADD, SUB, MULT, DIV, PWR, LD_STRING, LD_STR };
/* OPERATIONS: External Representation */
char *op_name[] = {"halt", "store", "jmp_false", "goto",
"data", "ld_int", "ld_var",
"in_int", "out_int",
"in_str", "out_string",
"lt", "eq", "gt", "add", "sub", "mult", "div", "pwr", "ld_string" };
struct instruction
{
enum code_ops op;
int arg;
...
/* Execute */
switch (ir.op) {
case HALT : printf( "" ); break;
case READ_INT : printf( "Entrada: " );
scanf( "%ld", &stack[ar+ir.arg] ); break;
case WRITE_INT : printf( "Salida: %d\n", stack[top--] ); break;
